...
## Environments
- Preview: https://main--lumieresurlasep--aemysites.aem.page/
- Live: https://main--lumieresurlasep--aemysites.aem.live/
- Block Library: https://main--lumieresurlasep--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `lumieresurlasep` directory in your favorite IDE and start coding :)
